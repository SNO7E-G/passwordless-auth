...
class WebAuthnService {
    ...
    generateRegistrationOptions(userId, username, displayName) {
        const challenge = (0, tokenGenerator_1.generateWebAuthnChallenge)();
        const rpId = new URL(config_1.default.baseUrl).hostname;
     ...
     */
    async verifyRegistration(userId, credential, deviceName) {
        ...
        try {
            ...
            if (!config_1.default.corsOrigins.includes(origin)) {
                return false;
            }
     ...
     * @returns Success status
     */
    removeCredential(credentialId, userId) {
...
exports.default = new WebAuthnService();
