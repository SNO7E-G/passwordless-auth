...
class TotpService {
     ...
     */
    generateTotpSetup(userId, issuer = 'PasswordlessAuth', accountName) {
        const secret = (0, tokenGenerator_1.generateTotpSecret)();
        // Store the secret
     ...
     */
    generateTotpCode(secret, window = 0) {
        // TOTP parameters
...
exports.default = new TotpService();
